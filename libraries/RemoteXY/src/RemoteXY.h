...
#elif defined(REMOTEXY_MODE__ARDUINO_NANO_RP2040_CONNECT)
  CRemoteXY *remotexy;      
  #define RemoteXY_Init() remotexy = new CRemoteXY (RemoteXY_CONF_PROGMEM, &RemoteXY, REMOTEXY_ACCESS_PASSWORD, new CRemoteXYStream_ArduinoBLE (REMOTEXY_BLUETOOTH_NAME)) 
