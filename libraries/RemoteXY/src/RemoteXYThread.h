...
class CRemoteXYThread : public CRemoteXYReceivePackageListener {
  ...
  void receivePackage (CRemoteXYPackage * package) override {
    RemoteXYDebugLog.write("Thead: receivePackage");
    uint16_t i, length;
    uint8_t *p, *kp, *ip; 
    ...
    switch (package->command) {  
      case 0x00:  
        ...
        if (available!=0) {
          RemoteXYDebugLog.write("sendPackage 1");
          ...
          *p++ = 0xf0;
          RemoteXYDebugLog.write("sendPackage 2");
          wire->sendPackage (0x00, buf, length,  0);
        }          
        break;   
      case 0x40:  
        copyInputVars ();
        RemoteXYDebugLog.write("sendPackage 3");
      ...
      case 0x80:
        ...
        RemoteXYDebugLog.write("sendPackage 4");
      ...
      case 0xC0: 
        ...
        RemoteXYDebugLog.write("sendPackage 5");
