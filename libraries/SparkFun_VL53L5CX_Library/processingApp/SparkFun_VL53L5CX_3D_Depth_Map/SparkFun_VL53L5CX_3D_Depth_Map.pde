...
int rows = 8;
int scale = 400; // Scale value for drawing our mesh
...
void setup(){
  ...
  port = new Serial(this, "COM10", 115200); // CHANGE COM13 TO YOUR SERIAL PORT
...
void draw(){
  ...
  for(int y=0; y<rows-1; y++){
    ...
    for(int x=0; x<cols; x++){
      fill(map(terrain[x][y]/10,0,400,255,0),255,255);
